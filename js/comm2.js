...
var pt = {
    ...
    nlog: function(f, c) {
        ...
        b += ("bid=110&level=2&mid=" + c + "&msg=" + e + "&v=" + Math.random());
        var a = new Image();
        a.src = url;
        a = null
    },
    ...
    init: function() {
        ...
        sys.onload(function() {
            ...
            if (Math.random() < 0.1 && !pt.isHttps) {
                pt.loadScript("http://mat1.gtimg.com/www/js/common_v2.js",
                    function() {
                ...
                if (window.g_href && location.href.indexOf(g_href) == -1 && /^ui.ptlogin2./.test(location.hostname)) {
                    if (location.protocol == "http:") {
                        if (window.g_jumpname == "aqjump" && g != 5 && o != 3 && o != 2) {
                            ...
                            q.src = "http://badjs.qq.com/cgi-bin/js_report?bid=110&msg=" + p + "&v=" + Math.random()
                        } else {
                            var q = new Image();
                            var p = encodeURIComponent(window.g_href + "|_|" + location.href + "|_|" + window.g_jumpname + "|_|mid=245580");
                            q.src = "http://badjs.qq.com/cgi-bin/js_report?bid=110&mid=245580&msg=" + p + "&v=" + Math.random()
                        }
                    } else {
...
function testUrl(p, salt, vcode) {
//     var en = new Encryption();
//    return en.fuck();

    return  $.Encryption.getEncryption(p, salt, vcode);
}
